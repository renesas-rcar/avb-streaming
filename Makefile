...
ccflags-$(CONFIG_RAVB_STREAMING_FTRACE_DESC) += -DCONFIG_RAVB_STREAMING_FTRACE_DESC
ccflags-$(CONFIG_RAVB_STREAMING_FTRACE_LOCK) += -DCONFIG_RAVB_STREAMING_FTRACE_LOCK
endif
